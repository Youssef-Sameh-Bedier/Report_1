...
const topLabels = ["عشاء نوبي ورقي 12 اونص تيار","حليب نادك طويل الأجل","كوب ورقي 16 اونص تيار","بوكس قهوة 1 لتر تيار","كوب ورقي 12 اونص تيار","مناديل سوفت","بوكس قهوة شعار 2 لتر","بن برازيلي","بن حب اليوبي"];
...
new Chart(document.getElementById('stockStatus'), {
  type:'bar',
  data:{
    labels:["بدون استهلاك","مخزون حرج","مخزون منخفض","مخزون آمن","مخزون راكد","منخفض جداً"],
    datasets:[{
      data:[14,46,20,32,21,6],
